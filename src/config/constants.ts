export const SITE_URL = 'https://healthinsurancecomparison.co.nz';
export const SITE_NAME = 'Health Insurance Comparison';
export const DEFAULT_META = {
  ...
  keywords: [
    ...
    'medical insurance new zealand'
  ],
  author: 'Health Insurance Comparison'
};