...
function UnimedReview() {
  const insuranceProduct = {
    name: "HealthCare Plus",
    provider: "UniMed",
    description: "Specialized workplace health insurance plan with family coverage options and preventive care focus.",
    monthlyPrice: 44.99,
    benefits: [
    ...
    url: "https://healthinsurancecomparison.co.nz/reviews/unimed"
  };
      ...
      <div className="bg-white">
        ...
        <div className="bg-blue-600 text-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl font-bold">UniMed Health Insurance Review</h1>
            <p className="mt-4 text-xl text-blue-100">
              Comprehensive review of UniMed's workplace and family health plans
            </p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="mb-12">
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <div className="flex items-center mb-6">
                ...
                />
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">About UniMed</h2>
                  <div className="flex items-center mt-2">
                    <Star className="w-5 h-5 text-yellow-400 fill-current" />
                    <span className="ml-1 font-semibold">4.4/5</span>
                    <span className="ml-2 text-gray-600">(680 reviews)</span>
                  </div>
                </div>
              </div>
              <p className="text-gray-700 leading-relaxed">
                UniMed specializes in workplace health plans with comprehensive family coverage options. 
                They focus on preventive care and day-to-day healthcare needs, making them popular 
                with employers and families seeking comprehensive health coverage solutions.
              </p>
            </div>
          </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <ul className="text-green-700 text-sm mt-2">
                    <li>• Workplace groups</li>
                    <li>• Families with children</li>
                    <li>• Preventive care focused</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Family Benefits</h3>
                <ul className="space-y-2 text-gray-600">
                  <li>• Family coverage options</li>
                  <li>• Children's health benefits</li>
                  <li>• Maternity care</li>
                  <li>• Pediatric services</li>
                </ul>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Workplace Plans</h3>
                <ul className="space-y-2 text-gray-600">
              ...
              <div className="bg-green-50 p-6 rounded-lg">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span className="text-green-700">Excellent workplace plans</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-green-700">Comprehensive family coverage</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-green-700">Preventive care focus</span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-5 h-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-green-700">Competitive group rates</span>
                  </li>
                </ul>
              </div>
              <div className="bg-red-50 p-6 rounded-lg">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span className="text-red-700">Limited individual plan options</span>
                  </li>
                  <li className="flex items-start">
                    <AlertCircle className="w-5 h-5 text-red-500 mr-2 flex-shrink-0 mt-0.5" />
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-700 mb-4">"Great family coverage through my workplace. The preventive care benefits are excellent."</p>
                <p className="text-sm text-gray-500">- Helen C., Rotorua</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <div className="flex items-center mb-4">
                  <div className="flex text-yellow-400">
                ...
                <p className="text-gray-700 mb-4">"Good value for workplace plans. Would like more individual options and digital services."</p>
                <p className="text-sm text-gray-500">- Peter L., New Plymouth</p>
              </div>
            </div>
          </div>
          ...
          {/* Contact Information */}
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Contact UniMed</h2>
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">0800 864 633</p>
                  </div>
                </div>
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@unimed.co.nz</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-blue-600 rounded-lg shadow-lg p-8 text-center text-white">
            <h2 className="text-2xl font-bold mb-4">Ready to Get a Quote from UniMed?</h2>
            <p className="text-blue-100 mb-6">
              Compare UniMed with other providers and find the best plan for your needs.
            </p>
